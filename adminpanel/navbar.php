                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card  shadow border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Home</div>
                                            <div class="h5 mb-0 font-weight-bold text-dark-400">Halaman Utama</div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-home fa-2x text-dark-300"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                               Kategori</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $jumlah_kategori; ?></div>
                                            
                                            <a href="kategori.php" class="card-link mt-2">Lihat Data</a>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-list fa-2x text-dark-300"></i>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <a href="produk.php" class="card-link mt-2">Lihat Data</a>
