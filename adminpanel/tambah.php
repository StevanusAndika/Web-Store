...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <h2 class="text-2xl">Tambah kategori</h2>

        <div class=" card my-5 col-12 col-md-6">
            ...
            <form action="" method="post">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="kategori" name="kategori" required
                        placeholder="input nama kategori..."autocomplete="off">
                </div>

                <div class="mt-3">
                    <button type="submit" class="btn btn-primary" name="simpan_kategori">Submit</button>
                </div>
            </form>
            ...
            if (isset($_POST['simpan_kategori'])) {
                ...
                $query_cek = mysqli_query($con, "SELECT * FROM kategori WHERE name= '$kategori'");
                $jumlah_data_kategori_baru = mysqli_num_rows($query_cek);
                if ($jumlah_data_kategori_baru > 0) {
                    echo "<div class='alert alert-danger'>Kategori sudah ada</div>";
                } else {
                    $query = mysqli_query($con, "INSERT INTO kategori (name) VALUES ('$kategori')");
                    if ($query) {
                        echo "<div class='alert alert-success'>Kategori Berhasil disimpan</div>";
                        echo "<meta http-equiv='refresh' content='2;url=kategori.php'>";
                    } else {
                        echo "<div class='alert alert-danger'>Kategori Gagal disimpan</div>";
                    }
                }
            }
            ?>
